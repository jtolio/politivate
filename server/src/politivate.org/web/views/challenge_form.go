...
<form name="newchallenge" method="POST">
  <div class="row">
    <div class="col-md-8">
      ...
      {{ template "input" (makemap "Field" "title" "Display" "Title" "Type" "text" "Form" .Form) }}
      {{ template "textarea" (makemap "Field" "description" "Display" "Description" "Form" .Form "Rows" 10) }}
    ...
    <div class="col-md-4">
      {{ $challengeType := (or (index .Form "type") "") }}
      <div class="form-group">
      ...
      {{ $phoneDatabase := (or (index .Form "phoneDatabase") "") }}
      <div id="phoneDatabaseSection" style="display: none;">
        ...
        <div id="specificPhoneSection" style="display: none;">
          {{ template "input" (makemap "Field" "directphone" "Display" "Phone number" "Type" "tel" "Form" .Form) }}
        </div>
      </div>

      {{ $locationDatabase := (or (index .Form "locationDatabase") "") }}
      ...
      {{ $dateType := (or (index .Form "dateType") "") }}
      <div class="form-group">
      ...
      <div id="eventStartSection" style="display: none;">
        {{ template "input" (makemap "Field" "eventStart" "Display" "Start time" "Type" "datetime-local" "Form" .Form) }}
      </div>
      <div id="eventEndSection" style="display: none;">
        {{ template "input" (makemap "Field" "eventEnd" "Display" (safehtml "<div id=\"eventEndLabel\">End time</div>") "Type" "datetime-local" "Form" .Form) }}
      </div>
    </div>
  </div>
...
<script>
  ...
  var restrictions = [
    {{ range $i, $e := (index .Form "restrictions") }}
...
{{.Page.DeferredSources.Add "https://maps.google.com/maps/api/js?key=` + mapsAPIKey + `&libraries=places"}}
{{.Page.DeferredSources.Add "/static/js/locationpicker.jquery.min.js"}}
{{.Page.DeferredFuncs.Add "initChallengeForm"}}`)
